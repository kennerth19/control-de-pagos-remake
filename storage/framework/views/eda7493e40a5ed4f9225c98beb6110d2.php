...
<head>
    ...
    <script src="<?php echo e(asset('js/pre_registro.js')); ?>"></script>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/pre_registro.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/pagos.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/nuevo_cliente.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/multipago.css')); ?>">
...
<body style="background-image: url('/control_de_pago_remake/public/img/inicio/background.png');">
    ...
    <?php if(session('pre_reg_editado') == 'ok'): ?>
    <script>
        Swal.fire({
            icon: 'success',
    ...
    <span id="tasa" style="display: none;"><?php echo e($tasa); ?></span>
    <span id="fecha" style="display: none;"><?php echo e($fecha); ?></span>
...
</html><?php /**PATH C:\xampp\htdocs\control_de_pago_remake\resources\views/pre_registro/pre_registro.blade.php ENDPATH**/ ?>