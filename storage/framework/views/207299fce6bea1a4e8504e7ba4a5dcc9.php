<style>
	...
	.side_bar {left: <?php echo e($left); ?>;/* Ignorar esto :V no hay error */}
...
<div class="side_bar" id="side_bar" onmouseover="side_bar_in()">
	<p class="side_item user" onclick="administrativo()" title="Ir al perfil de <?php echo e(Auth::user()->name); ?>"><img class="img_sidebar perfil_side_bar" src="/control_de_pago_remake/public/storage/perfil/<?php echo e(Auth::user()->perfil); ?>">Bienvenid@ <?php echo e(Auth::user()->name); ?></p>
	<p id="servidor_fecha"></p>

	<a href="<?php echo e(route('inicio')); ?>" class="side_item_contenedor" onmouseover="efecto('side_0', 'id_img_0', 'em4_0', 0)" onmouseleave="efecto('side_0', 'id_img_0', 'em4_0', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/homew.png" id="id_img_0">
	...
	<a href="<?php echo e(route('resumen_general')); ?>" target="_blank" class="side_item_contenedor" onmouseover="efecto('side_2', 'id_img_2', 'em4_2', 0)" onmouseleave="efecto('side_2', 'id_img_2', 'em4_2', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/mpw.png" id="id_img_2">
	...
	<a href="<?php echo e(route('pagos_resumen')); ?>" target="_blank" class="side_item_contenedor" onmouseover="efecto('side_3', 'id_img_3', 'em4_3', 0)" onmouseleave="efecto('side_3', 'id_img_3', 'em4_3', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/payw.png" id="id_img_3">
	...
	<a href="<?php echo e(route('modulo_de_cortes')); ?>" target="_blank" class="side_item_contenedor" onmouseover="efecto('side_4', 'id_img_4', 'em4_4', 0)" onmouseleave="efecto('side_4', 'id_img_4', 'em4_4', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/cortesw.png" id="id_img_4">
	...
	<a href="<?php echo e(route('evento_diario')); ?>" target="_blank" class="side_item_contenedor" onmouseover="efecto('side_5', 'id_img_5', 'em4_5', 0)" onmouseleave="efecto('side_5', 'id_img_5', 'em4_5', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/gastosw.png" id="id_img_5">
	...
	<a href="<?php echo e(route('pre_registro')); ?>" target="_blank" class="side_item_contenedor" onmouseover="efecto('side_6', 'id_img_6', 'em4_6', 0)" onmouseleave="efecto('side_6', 'id_img_6', 'em4_6', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/inicio/pre_registro.png" id="id_img_6">
	...
	<a href="<?php echo e(route('evento_admin')); ?>" target="_blank" class="side_item_contenedor" onmouseover="efecto('side_7', 'id_img_7', 'em4_7', 0)" onmouseleave="efecto('side_7', 'id_img_7', 'em4_7', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/safe.png" id="id_img_7">
	...
	<a href="<?php echo e(route('inventario')); ?>" target="_blank" class="side_item_contenedor" onmouseover="efecto('side_8', 'id_img_8', 'em4_8', 0)" onmouseleave="efecto('side_8', 'id_img_8', 'em4_8', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/caja.png" id="id_img_8">
	...
	<a href="<?php echo e(route('logout')); ?>" class="side_item_contenedor" onmouseover="efecto('side_9', 'id_img_9', 'em4_9', 0)" onmouseleave="efecto('side_9', 'id_img_9', 'em4_9', 1)"><img class="img_sidebar em1" src="/control_de_pago_remake/public/img/sidebar/e.png" id="id_img_9">
...
<script>
	...
	fecha_servidor();
</script><?php /**PATH C:\xampp\htdocs\control_de_pago_remake\resources\views/side_bar/side_bar.blade.php ENDPATH**/ ?>