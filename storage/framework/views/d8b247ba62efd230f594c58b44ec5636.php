...
<head>
    ...
    <link href="<?php echo e(asset('css/menu_administrativo.css')); ?>" rel="stylesheet">
    ...
    <script src="<?php echo e(asset('js/menu_administrativo.js')); ?>"></script>
...
<body style="background-image: url('/control_de_pago_remake/public/img/inicio/background.png');">
    ...
    <div class="menu_administrador">
        <div class="perfil" style="background-image: url('<?php echo e($perfil); ?>');" title="perfil de <?php echo e(Auth::user()->name); ?>"><img src="/control_de_pago_remake/public/img/perfil/camara.png" title="cambiar foto de perfil" class="camara" onclick="cambiar_eliminar(<?php echo e(Auth::user()->id); ?>)"></div>
        <p class="fecha_administrador"><i class="fa-regular fa-calendar-days"></i><?php echo e($hoy); ?></p>
    ...
    <div id="inicio" class="seccion">
        <h1 style="text-align: center;">Bienvenido <span id="username"><?php echo e(Auth::user()->name); ?></span></h1>
        
        <div class="sub_title">
            <h1 style="text-align: center;">Inicio</h1>
            <button onclick="editar_usuario(<?php echo e(Auth::user()->id); ?>)" class="button edit">Configurar usuario</button>
...
</html><?php /**PATH C:\xampp\htdocs\control_de_pago_remake\resources\views/configuracion/index.blade.php ENDPATH**/ ?>