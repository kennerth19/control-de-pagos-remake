...
<head>
    ...
    <link href="<?php echo e(asset('js/pago_resumen.js')); ?>" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/pago_resumen.css')); ?>">
...
<body style="background-image: url('/control_de_pago_remake/public/img/inicio/background.png');">
    ...
    <div class="controles">
        <div class="main_filtro">
            ...
            <div class="filtro">
            <label for="desde">
                Desde:<input type="date" class="input" value="<?php echo e($hoy); ?>" name="desde" id="desde">
            </label>
            <label for="hasta">
                Hasta:<input type="date" class="input" value="<?php echo e($hoy); ?>" name="hasta" id="hasta">
            </label>
            ...
            <select name="usuario" id="usuario" class="input" disabled>
                ...
                <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($usuario->name); ?>"><?php echo e($usuario->name); ?></option>
    ...
    <script src="<?php echo e(asset('js/pago_resumen.js')); ?>"></script>
...
<?php echo $__env->make('side_bar.side_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\control_de_pago_remake\resources\views//pagos/pagos_resumen.blade.php ENDPATH**/ ?>