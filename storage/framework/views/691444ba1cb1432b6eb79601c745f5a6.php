...
<body style="background-image: url('/control_de_pago_remake/public/img/inicio/background.png');">
    ...
    <div class="menu_date">
        ...
        <input type="date" id="filtro_fecha" value="<?php echo e($hoy); ?>" onchange="tabla_comprobar('Comprobando dia seleccionado...')">
        ...
        boton.addEventListener("click", function() {
            Swal.fire({
                ...
                <div class="container_comprobacion">
                    <input type="date" id="date_0" name="date_0" class="fecha_comprobar" value="<?php echo e($hoy); ?>">
                    <input type="date" id="date_1" name="date_1" class="fecha_comprobar" value="<?php echo e($hoy); ?>">
                </div>
...
<?php echo $__env->make('side_bar.side_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\control_de_pago_remake\resources\views/pagos/comprobar.blade.php ENDPATH**/ ?>