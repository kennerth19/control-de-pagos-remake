...
<head>
    ...
    <script src="<?php echo e(asset('js/evento_diario_2.js')); ?>"></script>
...
<body style="background-image: url('/control_de_pago_remake/public/img/inicio/background.png');">
    ...
    <div class="header">
        <h1 class="main_title">Caja fuerte</h1>
...
<?php echo $__env->make('side_bar.side_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\control_de_pago_remake\resources\views/evento_diario/caja_fuerte.blade.php ENDPATH**/ ?>