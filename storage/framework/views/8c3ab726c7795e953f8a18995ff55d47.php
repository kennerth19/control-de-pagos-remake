...
<body style="background-image: url('/control_de_pago_remake/public/img/inicio/background.png');">
    ...
    <script src="<?php echo e(asset('js/resumen_general.js')); ?>"></script>
    <style>.dt-search{display: none;}</style>
    <script src="<?php echo e(asset('js/header.js')); ?>"></script>
</body>

</html>
<?php echo $__env->make('side_bar.side_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\control_de_pago_remake\resources\views/resumen_general/resumen_general.blade.php ENDPATH**/ ?>