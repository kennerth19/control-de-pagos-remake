...
<body style="background-image: url('/control_de_pago_remake/public/img/inicio/background.png');">
    ...
    <script>
        function pagomovil() {
            window.open("{{route('pagomovil_print')}}", "_blank");
        }

        function zelle() {
            window.open("{{route('zelle_print')}}", "_blank");
        }

        function multipago() {
            window.open("{{route('multi_pagos')}}", "_blank");
        }
    </script>

    <div class="sort">
        <img src="{{ asset('img/inicio/flecha.png') }}" alt="" class="sort_img estado_base" id="flecha_der" onclick="mostrar_menu(0)">

        <img src="{{ asset('img/inicio/multipago.png') }}" id="item_8" alt="" onclick="multipago()" class="sort_img botones estado_base" title="Multi pagos">
        <img src="{{ asset('img/inicio/calculadora.png') }}" id="item_7" alt="" onclick="calculadora({{$tasa}})" class="sort_img botones estado_base" title="Servicio prepago">
        <img src="{{ asset('img/inicio/pm.png') }}" id="item_6" alt="" onclick="pagomovil()" class="sort_img botones estado_base" title="Imprimir datos de pagomovil">
        <img src="{{ asset('img/inicio/zl.webp') }}" id="item_5" alt="" onclick="zelle()" class="sort_img botones estado_base" title="Imprimir datos del zelle">
        <img src="{{ asset('img/inicio/servicio.png') }}" id="item_4" alt="" onclick="agregar_servicio({{$tasa}})" class="sort_img botones estado_base" title="Agregar pago de un servicio">
        <img src="{{ asset('img/inicio/pre_registro.png') }}" id="item_3" class="sort_img botones estado_base" onclick="agregar_instalacion({{$tasa}})" title="Agregar nueva instalación">
        <img src="{{ asset('img/inicio/new.png') }}" id="item_2" class="sort_img new_user_button botones estado_base" onclick="agregar_cliente()" title="Agregar nuevo cliente">
        <img src="{{ asset('img/inicio/tasa.png') }}" id="item_1" class="sort_img botones estado_base" onclick="editar_tasa({{$tasa}})" title="Cambiar tasa">

        <img src="{{ asset('img/inicio/flecha.png') }}" alt="" style="transform: rotate(180deg); width: 50px; cursor: pointer; filter: grayscale(100%);" id="flecha_izq" onclick="mostrar_menu(1)">
    </div>
